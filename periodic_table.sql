...
ALTER TABLE
    public.elements OWNER TO freecodecamp;
...
ALTER TABLE
    public.properties OWNER TO freecodecamp;
...
ALTER TABLE
    public.types OWNER TO freecodecamp;
...
ALTER TABLE
    public.types_type_id_seq OWNER TO freecodecamp;
...
ALTER COLUMN
    type_id
SET
    DEFAULT nextval('public.types_type_id_seq' :: regclass);
...
--
SELECT
    pg_catalog.setval('public.types_type_id_seq', 3, TRUE);
...
ADD
    CONSTRAINT elements_atomic_number_key UNIQUE (atomic_number);
...
ALTER TABLE
    ONLY public.elements
ADD
    CONSTRAINT elements_name_key UNIQUE (name);
...
ALTER TABLE
    ONLY public.elements
ADD
    CONSTRAINT elements_symbol_key UNIQUE (symbol);
...
ADD
    CONSTRAINT properties_atomic_number_key UNIQUE (atomic_number);
